			...
			do
			{
				...
				{	
					for(k=0;k<10;k++)
					{
								...
								g_result[base+cnt[tid]].col1[k]=g_order[point].col1[k];
					
					}
					for(k=0;k<10;k++)
					{
			
								g_result[base+cnt[tid]].col2[k]=g_user[i].col1[k];
		
					}
					for(k=0;k<10;k++)
					{
		
								g_result[base+cnt[tid]].col3[k]=g_order[point].col2[k];
			
					}
					for(k=0;k<10;k++)
					{
	
								g_result[base+cnt[tid]].col4[k]=g_user[i].col2[k];
						
					}	
					g_result[base+cnt[tid]].flag=1;
